...
print("Selamat! Anda mendapat nilai A dan telah berkelakuan baik" if nilai>=80 and perilaku == 'baik' else "Kamu mendapatkan nilai A, tetapi perilaku Anda kurang baik")
